...
class VGGM(nn.Module):
    ...
    def __init__(self, num_classes=1000, hdim=4096):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.5),
            nn.Linear(int(hdim) ,num_classes)
        )
...
def vggm_1024(pretrained=True, num_classes=1000):
    m = VGGM(num_classes=num_classes, hdim=1024)
    if pretrained:
        d = torch.load('/home/Deep_Learner/work/cleaned/models/backbones/vggm1024-caffe.pt')
        m.load_state_dict(d)
    return m